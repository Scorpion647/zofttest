...
export default function Admin() {
  ...
  const obtenerValorDesdeDB = async () => {
    try {
      const users = await selectProfiles({
        limit: 200,
        page: 1,
        equals: { user_role: "guest" },
      });
      const bills = await selectInvoice_data({
        limit: 200,
        page: 1,
  ...
  return (
    <ChakraProvider>
      <div className="flex h-full w-full items-center justify-center bg-gradient-to-tr from-green-900 to-green-700 p-4">
        <div className={`relative flex w-full max-w-6xl`}>
          <Box position="relative"></Box>

          {/* Caja Principal */}
          <div
            className={`relative rounded-3xl border border-gray-300 bg-gradient-to-tr from-gray-200 to-gray-300 p-4 text-center shadow-md ${showRightBox ? "md:w-2/3" : "w-full"} flex flex-col`}>
            <Flex
              width="100%"
              alignItems="center"
            ...
            <HStack
              ...
              spacing={2}
              align="stretch"
              className="[@media(max-width:1430px)]:max-h-[450px] [@media(min-width:1440px)]:max-h-[500px]">
              <VStack
                justify="center"
                width={MenuL ? "7%" : "15%"}
                bg="white"
                ...
                <VStack
                  height={iLargeScreen ? "" : "60%"}
                  justify={iLargeScreen ? "center" : ""}>
                  <MainButton
                    onClick={() => screen(1)}
                    text="Gestion de OCs"
                    icon={
                ...
                <VStack
                  ...
                  height="20%">
                  <Tooltip
                    label={PendingUsers > 0 ? "Hay Usuarios pendientes" : ""}>
                    <Button
                      onClick={() => screen(2)}
                      position="relative"
                  ...
                  <Tooltip
                    label={Pendingbills > 0 ? "Hay Registros pendiente" : ""}>
                    <Button
                      onClick={() => screen(1)}
                      position="relative"
                      colorScheme="transparent"
                    ...
                    <>
                      <VStack
                        ...
                        <Text
                          ...
                          textColor="gray.500"
                          fontSize="80%">
                          El gestor de facturación que necesitas
                        </Text>
                      </VStack>
                    </>
                  )}
            ...
            <EmailListModal isOpen={IsOpenmenu} onClose={OnClosemenu} />
          ...
          {AddDomain && (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 transition-opacity duration-300">
              <div className="relative z-20 w-5/6 max-w-md rounded-3xl border border-gray-300 bg-white p-4 text-center shadow-md">
                <h2 className="mb-4 text-xl font-bold">Asociar factura</h2>
                ...
                <HStack
                  ...
                  <Button
                    bg="red"
                    textColor="white"
                    className="py- mt-4 rounded px-4"
