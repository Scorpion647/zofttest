...
export const Associate_invoice = ({
  ...
  const pruebas = async () => {
    ...
    try {
      ...
      setisActive(
        invoice.state === "approved" ? false
        : invoice.state === "pending" ? false
        : true,
      );
      setButton(
        invoice.state === "approved" ? false
        : invoice.state === "pending" ? true
        : false,
      );
        ...
        if (datas && datas.base_bill_id) {
          try {
            ...
            if (!purchase) {
              ...
              updateSharedState(
                "TRM",
                datas.billed_currency === "COP" ? false : true,
              );
            ...
            console.error(
              "Error fetching bill for base_bill_id:",
              datas.base_bill_id,
              err,
            );
          }
      ...
      if (hot && !hot.isDestroyed) {
        ...
        console.log(
          "No hay cambios para aplicar o la instancia de Handsontable no está disponible.",
        );
      }
  ...
  const handleCellDoubleClick = async (event, coords, TD) => {
    ...
    const record = records.find(
      (r) => Number(r.item) === Number(pos) && r.purchase_order === orderNumber,
    );
    if (!record?.item) {
      updateSharedState("descripcion", "NaN");
      updateSharedState("cantidadoc", 0);
      ...
      if (
        ...
        if (isTable !== "Create") {
          const supplierdata = await selectSupplierData({
            ...
            equals: {
              invoice_id: invoi,
              base_bill_id: matchedRecord.base_bill_id,
            },
          });
        ...
        if (
          ...
          updateSharedState(
            ...
            total_quantity -
              ...
              supplierdata[0]?.billed_quantity,
          );
          updateSharedState("totalOC", total_quantity);
          updateSharedState(
            "OCusada",
        ...
        const bulto = ((percentage * (sharedState.bultos || 0)) / 100).toFixed(
          3,
        );
            ...
            <HStack width="100%" height="20%">
              ...
              <VStack width="60%" align="end" justify="end">
                <Input
                  ...
                  value={
                    isTable !== "Create" ? sharedState.pesototal : undefined
                  }
                  backgroundColor="white"
                  border="1px"
                />
            ...
            <HStack width="100%" height="20%">
              ...
              <VStack width="60%" align="end" justify="end">
                <Input
                  ...
                  value={
                    isTable !== "Create" ? sharedState.nofactura : undefined
                  }
                  backgroundColor="white"
                  border="1px"
                />
          ...
          <HotTable
                  ...
                  if (
                    ...
                    if (exists === false) {
                      cellProperties.renderer = (
                        ...
                        content.textContent =
                          hotInstance.getDataAtCell(row, col) || "";
                    ...
                    cellProperties.renderer = (
                      ...
                      td.setAttribute(
                        "title",
                        "Registre subpartida, parámetro de 10 digitos obligatorio",
                      );
              ...
              if (source === "edit") {
                ...
                for (const [
                    ...
                    if (
                      ...
                      if (!getCounter(rowIndex)) {
                        if (!isLoading2) {
                          ...
                          console.log(
                            "Valor revertido después de la verificación.",
                          );
                        } else {
                        ...
                        console.log(
                          "La fila tiene secuencia automática, no se revertirá el valor.",
                        );
                      }
                  ...
                  if (colIndex === 2) {
                    ...
                    const record = await selectByPurchaseOrder(
                      orderNumber,
                      value1,
                    );
                    ...
                    if (isTable === "Create") {
                      if (
                        parseFloat(record[0]?.total_quantity) ===
                        parseFloat(record[0]?.approved_quantity) +
                          parseFloat(record[0]?.pending_quantity)
                      ) {
                        ...
                        valueX > parseFloat(record[0]?.total_quantity) ||
                        valueX < 1
                      ) {
                        hot.setDataAtCell(rowIndex, colIndex, "");
                      }
                      ...
                      const supplierdata = await selectSupplierData({
                        ...
                        equals: {
                          invoice_id: invoi,
                          base_bill_id: record[0]?.base_bill_id,
                        },
                      });
                      let cantidad = 0;
                      cantidad = supplierdata[0]?.billed_quantity || 0;
                      if (
                        (valueX >
                          record[0]?.total_quantity -
                            (record[0]?.approved_quantity +
                              record[0]?.pending_quantity) +
                            supplierdata[0]?.billed_quantity ||
                          valueX < 1) &&
                        cantidad > 0
                      ) {
                        ...
                        if (
                          valueX > record[0]?.total_quantity ||
                          valueX +
                            (record[0]?.pending_quantity +
                              record[0]?.approved_quantity) >
                            record[0]?.total_quantity
                  ...
                  if (colIndex === 4) {
                    const totalSum = data.reduce((sum, row) => {
                      const unip =
                        parseFloat(String(row[3]).replace(/[$,]/g, "")) || 0;
                      const can = parseFloat(row[2]) || 0;
                      return unip > 0 && can > 0 ? sum + unip * can : sum;
                    }, 0);
                    updateSharedState(
                      "totalfactura",
                      formatMoney(totalSum.toFixed(2)),
                    );
                  }
                  ...
                  if (colIndex === 2 || colIndex === 3) {
                    ...
                    if (
                      hot.getDataAtCell(rowIndex, 0) &&
                      hot.getDataAtCell(rowIndex, 1)
                    ) {
                      try {
                        ...
                        console.error(
                          "Error calculando el valor para la fila",
                          rowIndex,
                          error,
                        );
                        hot.setDataAtCell(rowIndex, 4, "");
                  ...
                  if (
                    ...
                    if (Number(record.item) === Number(pos)) {
                      ...
                      if (
                        parseFloat(approved_quantity) +
                          parseFloat(pending_quantity) <
                        ...
                        try {
                          ...
                          const materialDetails = materialResults.find(
                            (m) =>
                              String(m.material_code) ===
                              String(record.material_code),
                          );
                        ...
                        if (
                          ...
                          hot.setDataAtCell(
                            ...
                            String(
                              formatMoney(
                                (unit_price / 100) * sharedState.TRMCOP,
                              ),
                            ),
                          );
                        } else if (
                      ...
                      console.log(
                        `No matching record found for row ${rowIndex}`,
                      );
                    }
                  }
                }
              ...
              if (source === "CopyPaste.paste") {
                const paste = debounce(async () => {
                  ...
                  const changePromises = changes.map(
                    async ([rowIndex, colIndex, oldValue, newValue]) => {
                      ...
                      if (colIndex === 2) {
                        ...
                        if (isTable === "Create") {
                          if (
                            ...
                            parseFloat(record.approved_quantity) +
                              parseFloat(record.pending_quantity)
                          ) {
                            ...
                            if (
                              valueX > parseFloat(record.total_quantity) ||
                              valueX < 1
                            ) {
                              batchChanges.push([rowIndex, colIndex, ""]);
                            }
                          ...
                          const supplierdata = await selectSupplierData({
                            ...
                            equals: {
                              invoice_id: invoi,
                              base_bill_id: record.base_bill_id,
                            },
                          });
                          if (
                            valueX >
                      ...
                      if (colIndex === 4) {
                        const totalSum = data.reduce((sum, row) => {
                          const unip =
                            parseFloat(String(row[3]).replace(/[$,]/g, "")) ||
                            0;
                          const can = parseFloat(row[2]) || 0;
                          return unip > 0 && can > 0 ? sum + unip * can : sum;
                        }, 0);
                      ...
                      if (colIndex === 2 || colIndex === 3) {
                        const result =
                          data[rowIndex][2] *
                          parseFloat(
                            String(data[rowIndex][3]).replace(/[$,]/g, ""),
                          );
                        batchChanges.push([
                          rowIndex,
                          4,
                        ...
                        try {
                          ...
                          if (Number(record.item) === Number(pos)) {
                            ...
                            if (
                              ...
                              try {
                                subheading =
                                  materialDetails.data[0].subheading ||
                                  undefined;
                            ...
                            console.log(
                              `No se encontró registro coincidente para la fila ${row}`,
                            );
                          }
                        } catch (error) {
                          console.error(
                            `Error procesando registros para la fila ${row}:`,
                            error,
                          );
                        }
                      })(),
            ...
            contextMenu={{
              callback: (key, options) => {
                setTimeout(() => {}, 100); // 🕐 Espera 100ms antes de ejecutar
              },
              items: {
                copy: { name: "Copiar" },
                cut: { name: "Cortar" },
