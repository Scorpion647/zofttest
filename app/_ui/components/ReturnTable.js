...
const ReturnTable = ({ suppliers, volver }) => {
  ...
  const Delete = async () => {
    ...
    try {
      ...
      const doc = await getDocDownloadLink(
        invo.invoice_docs[invo.invoice_docs.length - 1],
        invo.supplier_id,
      );
